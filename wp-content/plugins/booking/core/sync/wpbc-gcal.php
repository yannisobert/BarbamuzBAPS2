                ...
                <div class="modal-footer" style="text-align:center;"> 
                    ...
                    <a href="javascript:void(0)" class="button button-primary"  style="float:none;"                                        
                       onclick="javascript:wpbc_import_gcal_events('<?php echo get_bk_current_user_id(); ?>'
                            ...
                            );jQuery('#wpbc_gcal_import_events_modal').wpbc_my_modal('hide');"
    ...
    $params = array(  
                    ...
                    , 'items' => array(
                                        array(                                                 
                                            ...
                                            , 'action' => " if ( 'function' === typeof( jQuery('#wpbc_gcal_import_events_modal').wpbc_my_modal ) ) {
                                                                jQuery('#wpbc_gcal_import_events_modal').wpbc_my_modal('show');
                                                            } else {
                                            ...
                                            , 'icon' => ''
                                            , 'font_icon' => 'wpbc_icn_file_download'
